...
This file is the quick-reference operating contract for bm25-kotlin. The longer
...
bm25-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`bm25`](https://crates.io/crates/bm25). Upstream Rust is the behavioral oracle while the
