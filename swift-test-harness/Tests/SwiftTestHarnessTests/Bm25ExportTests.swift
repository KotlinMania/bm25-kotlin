...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Bm25.swiftmodule/`
...
//      `import Bm25` above would fail at compile time.
//
//   2. The static archive `libBm25.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Bm25" }` and
//      `flattenPackage = "io.github.kotlinmania.bm25"` configuration in
